...
ra_model=pickle.load(open("C:\\Users\\DELL\\Desktop\\ML_chaitanya\\ra_model.sav",'rb'))

mrr_model=pickle.load(open("C:\\Users\\DELL\\Desktop\\ML_chaitanya\\mrr_model.sav",'rb'))
